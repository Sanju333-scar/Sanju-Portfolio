...
export const timelineData: TimelineItem[] = [
  {
    id: 1,
    type: 'work',
    title: 'Python & React.js Intern',
    company: 'M-Squared',
    location: 'Remote',
    date: 'Apr 2025 - May 2025',
    imageURL: '/msquared.png',
    description:
      'Built and troubleshot web applications using Python for backend logic and React.js for interactive frontend experiences.',
    achievements: [
      'Developed backend logic and APIs using Python to support web application functionality.',
      'Built interactive and responsive frontend components using React.js.',
      'Collaborated with the team to debug issues and optimize overall application performance.',
      'Ensured seamless frontend-backend integration for a smooth user experience.',
    ],
